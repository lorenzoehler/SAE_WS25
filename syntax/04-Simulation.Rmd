---
title: "Batch-Iteration über alle Samples"
...
# Modellformeln (reduzierte Formel nach Stepwise; für beide Modelle konsistent)
...
```{r}
summary_final <- read.csv("../data_raw/simulation/models/summary_final.csv")
reactable(summary_final,compact = T,filterable = T)
```
