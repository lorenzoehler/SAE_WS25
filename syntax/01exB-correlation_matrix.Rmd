...
# Introduction
This script creates a correlation matrix between all variables of our data set, using Cramers V and the the sample we will also use for model specification.
Further, we will create groups for highly correlated Variables and select one to represent this group.
